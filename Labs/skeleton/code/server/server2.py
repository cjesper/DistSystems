...
#------------------------------------------------------------------------------------------------------
    def do_POST(self):
        ...
        '''
        elif self.path == '/propagateAdd':
            self.add_to_store()
        
        elif self.path == '/propagateDel':
            self.delete_from_store()
            
        elif self.path == '/propagateMod':
        ...
        '''
        elif self.path == '/leaderAdd': 
            self.leader_add()

        elif self.path == '/leaderMod': 
            self.leader_modify()
        
        elif self.path == '/leaderDel': 
            self.leader_delete()
